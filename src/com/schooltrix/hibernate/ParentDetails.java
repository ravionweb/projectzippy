...
public class ParentDetails implements java.io.Serializable {
	...
	/** minimal constructor */
	public ParentDetails(String firstName, String lastName, String gender,
			String address1, String city, String state, String email,
			String mobile, String dob, String isDefault, String active) {
	...
	public ParentDetails(Long umId, String firstName, String lastName,
			...
			String dob, String photo, String ptmId, String isDefault,
			String active) {
		this.umId = umId;
		this.firstName = firstName;
		this.lastName = lastName;
