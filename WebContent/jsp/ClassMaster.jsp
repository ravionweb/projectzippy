 ...
 <div style="height:50px;"></div>
	<div class="reg_mainCon">
     ...
     <fieldset>
	  ...
	  <form  method="post"  action="classmasterXL.action" enctype="multipart/form-data" onsubmit="return validate(this)" >
	   ...
	   <table width="100%" border="0" cellspacing="0" cellpadding="0">
	    ...
	    <tr><td>&nbsp;</td></tr>
		 ...
		 <tr><td>&nbsp;</td></tr>
		   <tr>			  
			  <td width="20%"><label style="color:#000;"><b>Class Master</b></label></td>
	          <td colspan="2">
	 ...
	 --%>
	    ...
	    <div style="float: right;">
		      <form  method="post"    action="download.action">
				   ...
				   <table width="100%" border="0" cellspacing="0" cellpadding="0">
						 <tr> <td><input type="hidden" name="fileName" id="fileName"   value="class_upload.csv" >
